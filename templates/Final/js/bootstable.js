...
function rowEdit(but) {  //Inicia la edición de una fila
    ...
    IterarCamposEdit($cols, function($td) {  //itera por la columnas
        ...
        //adapt to our case ----------------Edition by DGT-----------------------
        cont=cont.replace("<span>","");
        cont=cont.replace("</span>",""); 
        var div = '<div style="display: none;"><span>' + cont + '</span></div>';  //guarda contenido
...
function TableToCSV(tabId, separator) {  //Convierte tabla a CSV
    ...
    $tab_en_edic.find('thead tr').each(function() {
        var $cols = $(this).find('th');  //lee campos
        datFil = '';
        $cols.each(function() {
            rep=$(this).html();
            rep=rep.replace("<span>","");
            rep=rep.replace("</span>","");
            //Eliminate the first column which is just the index
            if(rep.match(/#/g)){}
            else{
                datFil = datFil + rep + separator;
            }
